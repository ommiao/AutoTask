...
public class GalleryItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public void getItemOffsets(Rect outRect, final View view, final RecyclerView parent, RecyclerView.State state) {
        ...
        Logger.d(TAG, "GalleryItemDecoration getItemOffset() --> position = " + parent.getChildAdapterPosition(view));
    ...
    private void onSetHorizontalParams(ViewGroup parent, View itemView, int position, int itemCount) {
        ...
        Logger.d(TAG, "GalleryItemDecoration onSetHorizontalParams -->" + "parent.width=" + parent.getWidth() + ";mPageMargin=" + OsUtil.dpToPx(mPageMargin)
    ...
    private void setLayoutParams(View itemView, int left, int top, int right, int bottom, int itemWidth, int itemHeight) {
        ...
        Logger.d(TAG, "GalleryItemDecoration setLayoutParams -->" + "left=" + left + ";top=" + top
