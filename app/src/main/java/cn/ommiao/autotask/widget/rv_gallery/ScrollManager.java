package cn.ommiao.autotask.widget.rv_gallery;
...
import cn.ommiao.autotask.widget.rv_gallery.util.OsUtil;
...
public class ScrollManager {
    ...
    public void updateConsume() {
        ...
        Logger.d(TAG, "ScrollManager updateConsume mConsumeX=" + mConsumeX);
    }
    ...
    class GalleryScrollerListener extends RecyclerView.OnScrollListener {
        ...
        public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
            Logger.d(TAG, "ScrollManager newState=" + newState);
    ...
    private void onVerticalScroll(final RecyclerView recyclerView, int dy) {
        ...
        recyclerView.post(new Runnable() {
            ...
            public void run() {
                ...
                Logger.i(TAG, "ScrollManager offset=" + offset + "; mConsumeY=" + mConsumeY + "; shouldConsumeY=" + mPosition);
    ...
    private void onHorizontalScroll(final RecyclerView recyclerView, final int dx) {
        ...
        recyclerView.post(new Runnable() {
            ...
            public void run() {
                ...
                Logger.i(TAG, "ScrollManager offset=" + offset + "; percent=" + percent + "; mConsumeX=" + mConsumeX + "; shouldConsumeX=" + shouldConsumeX + "; position=" + mPosition);
